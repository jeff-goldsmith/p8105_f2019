...
This is the third module in the [Linear Models](topic_linear_models.html) topic; the relevant slack channel is [here](https://p8105-fall2018.slack.com/messages/CCAAE9AAU).
...
As with $r^2$, this distrubtion is somewhat skewed and has some outliers. 
