...
This page is related to content in [plotly and dashboards](plotly_and_dashboards.html), and the slack channel for extra topics is [here](https://p8105-fall2018.slack.com/messages/CEC9L1JKV).
...
I'll add the following libraryies to the template, but we won't need much else.
