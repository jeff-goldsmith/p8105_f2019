...
This is the second module in the [Building blocks](topic_building_blocks.html) topic; the relevant slack channel is [here](https://p8105-fall2018.slack.com/messages/CCATLJG67).
...
<script async class="speakerdeck-embed" data-id="f1ca5d878d3f429692f3350bd4ef8f77" data-ratio="1.77777777777778" src="//speakerdeck.com/assets/embed.js"></script>
...
Below is a first RMD file. To follow along, create a .Rmd file using File > New File > R Markdown, and replace the default text with what's below. 
...
Soon we'll see the `github_document` format, and later in the course we'll talk about some other output formats -- especially dashboards and websites -- introducing other YAML options as needed.
