...
Next I'll add an R Markdown file looking at (shown below) to my repository / directory.
...
For the repository holding this example, I'll add Angel as a collaborator. Once she's been added, she's going to add a histogram of `y` to our basic plot RMD. He'll commit and push; I'll relax until he's done, then pull her changes from the remote repository to my local repository. Those changes will appear in my local repository, and a summary of the changes are in my git history. 

<img src="images/git_collab_commit.png" style="width:80%">

Of course, team members may want to work in parallel. As an example, I'll edit the README a bit and Angel will add the RMD file for vector classes. Once I've written my code, I'm going to commit; pull to see if there are any changes in the remote repository; and then push everything.
...
After resolving conflicts, should commit the changes and push the new unified version to the remote repository.
