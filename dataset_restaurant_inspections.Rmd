...
Data on restaurant inspection results are publicly available at [NYC Open Data](https://dev.socrata.com/foundry/data.cityofnewyork.us/43nn-pn8j) and are updated daily. The specific data to be used in this class, linked to at the top of this page, was accessed in October 2017 using the code below.
