...
You will work closely with other classmates in a team of 4-5 on this project, and are free to form teams of your choosing. If you can't find a team, or wish to form a team of a different size, please reach out to the instructor. In general, we do not anticipate that the grades for each group member will be different. We do, however, reserve the right to assign different grades to each group member based on peer assessments or public records of contribution (e.g. through commit histories).
...
November 12-16        | Project review meeting              | In person meeting -- no "deliverable"
...
December 11           | "In class" discussion of projects   | Enjoy hearing about projects! (Also get hex stickers...)
...
You will create a webpage summarizing your project. This should not be as detailed as your submitted report, but should give a overview of the project scope, data, approaches, visualizations, and other results. You should also link to the full report and repo. 
